...
```bash
npm install @stdlib/assert-has-dataview-support
```
...
```bash
npm install -g @stdlib/assert-has-dataview-support
```
...
[test-image]: https://github.com/stdlib-js/assert-has-dataview-support/actions/workflows/test.yml/badge.svg
[test-url]: https://github.com/stdlib-js/assert-has-dataview-support/actions/workflows/test.yml
...
[@stdlib/assert/has-arraybuffer-support]: https://www.npmjs.com/package/@stdlib/assert-has-arraybuffer-support
